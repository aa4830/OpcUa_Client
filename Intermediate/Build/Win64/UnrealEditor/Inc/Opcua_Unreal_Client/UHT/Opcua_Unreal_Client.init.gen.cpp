...
void EmptyLinkFunctionForGeneratedCodeOpcua_Unreal_Client_init() {}
	static FPackageRegistrationInfo Z_Registration_Info_UPackage__Script_Opcua_Unreal_Client;
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_Opcua_Unreal_Client()
	{
		if (!Z_Registration_Info_UPackage__Script_Opcua_Unreal_Client.OuterSingleton)
		{
			static const UECodeGen_Private::FPackageParams PackageParams = {
				"/Script/Opcua_Unreal_Client",
				nullptr,
				0,
